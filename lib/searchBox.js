    ...
    _createClass(SearchBox, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                searchbox = _props.searchbox;

            var prefixClassName = defaultProps.prefixClassName;
            var placeholder = searchbox && searchbox.placeholder || 'Search';
            var _className = prefixClassName + '-SearchBox';
            var _wrapperClassName = prefixClassName + '-SearchBox-Wrapper';
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { className: prefixClassName + '-SearchBox-input', type: 'text', onInput: this.onInput, onKeyDown: this.onKeyDown, placeholder: placeholder }),
                    _react2.default.createElement(
                        'span',
