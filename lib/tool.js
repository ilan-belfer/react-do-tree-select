...
var getFilterIdList = exports.getFilterIdList = function getFilterIdList(idList, treeDataMap, val) {
    ...
    idList.forEach(function (item) {
        ...
        if (value) formetedValue = value.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase();
...
var unExpandList = exports.unExpandList = function unExpandList(idList, treeDataMap) {
    var _filterIdList = [];
    idList.forEach(function (item) {
        var _treeDataMap$item3 = treeDataMap[item],
            title = _treeDataMap$item3.title,
            value = _treeDataMap$item3.value,
            children = _treeDataMap$item3.children,
            parentVal = _treeDataMap$item3.parentVal;
